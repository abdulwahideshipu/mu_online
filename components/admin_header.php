...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">MU Online</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../components/admin_logout.php" onclick="return confirm('Logout from this website?');"><i class="fas fa-right-from-bracket"></i><span>Log out</span></a>
   </nav>
